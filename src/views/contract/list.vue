        ...
        <el-table-column label="Action" width="300" align="center">
          <template slot-scope="scope">
            ...
            <!-- <el-tooltip class="item" effect="dark" content="Edit Contract" placement="top-start">
              <el-button icon="el-icon-edit" type="primary" plain circle size="mini"></el-button>
            </el-tooltip>
            <el-tooltip class="item" effect="dark" content="Upload Attactments" placement="top-start">
            ...
            <el-tooltip class="item" effect="dark" content="Release Contract" placement="top-start">
              <el-button type="success" plain icon="el-icon-check" circle size="mini" @click="goRelease(scope.row)"></el-button>
            </el-tooltip>-->
